...
error_reporting(E_ALL);
	...
	$users = "users";
	//write query
	$query = "SELECT $tbl.photoID, $tbl.photoSRC, $tbl.photoCaption, $users.userName FROM $tbl, $users WHERE $tbl.userID = $users.userID ORDER BY $tbl.photoID DESC";
	...
	//bind results
	$displayStmt->bind_result($photoID, $photoSRC, $photoCaption, $userName);
	...
	while($displayStmt->fetch()){
		...
		$imagesArray[] = [$photoID, $photoSRC, $photoCaption, $userName];
